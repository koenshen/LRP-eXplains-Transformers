...
def latex_heatmap(words, relevances, cmap="bwr", path='heatmap.tex'):
    """
    Generate a LaTeX file with a heatmap of the relevances of the words in a sentence.
    This function only generates the LaTeX file without compiling it to PDF.
    ...
    cmap : str
        The name of the colormap to use.
    path : str
        The path to save the LaTeX file.
    """
    ...
    print(f"LaTeX file generated successfully at {path}.")
